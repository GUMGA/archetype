 ...
 */
 define([
    ...
    'app/modules/gumga/directives/GumgaManyToOne/GumgaManyToOne',
    'app/modules/gumga/directives/GumgaAlert/GumgaAlert',
    'app/modules/gumga/directives/GumgaGoogleMaps/GumgaGoogleMaps',
    'app/modules/gumga/directives/GumgaOneToMany/GumgaOneToMany',
    'app/modules/gumga/directives/GumgaBreadCrumb/GumgaBreadCrumb',
    'app/modules/gumga/directives/GumgaUpload/GumgaUpload',
    'app/modules/gumga/directives/GumgaImage/GumgaImage',
    ...
    return angular.module('gumga.core', ['ui.bootstrap', 'ui.router','gumga.filter'])
        ...
        .directive('gumgaOneToMany',GumgaOneToMany)
        .directive('gumgaManyToMany', GumgaManyToMany)
        .directive('gumgaManyToOne',GumgaManyToOne)
        .directive('gumgaAlert', GumgaAlert)
        .directive('gumgaImage', GumgaImage)
        .directive('gumgaBreadcrumb',GumgaBreadcrumb)
