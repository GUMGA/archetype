...
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"${package}"})
...
//        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/${parentArtifactId}?zeroDateTimeBehavior=convertToNull");
