...
@SpringBootApplication(scanBasePackages = {"${package}.${parentArtifactId}.boot.components",
                                           "${package}.${parentArtifactId}.application.service",
                                           "io.gumga",
                                           "${package}.${parentArtifactId}.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"${package}.${parentArtifactId}.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:${parentArtifactId};MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "${package}.${parentArtifactId}.domain.model");
