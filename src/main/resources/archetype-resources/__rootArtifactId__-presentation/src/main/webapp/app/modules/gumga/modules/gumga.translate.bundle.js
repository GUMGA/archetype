...
define(function(require){
    ...
    return angular.module('gumga.translate',[])
        .directive('gumgaTranslate',function GumgaTranslate($http,GumgaTranslateHelper){
            var ch = 0;
            return {
                restrict: 'AEC',
                scope: false,
        ...
        .directive('gumgaTranslateTag',function GumgaTranslateTag(GumgaTranslateHelper,$compile){
            var child;
            return {
                restrict: 'A',
                scope: {
        ...
        .factory('GumgaTranslateHelper',function GumgaTranslateHelper(){
            return {
