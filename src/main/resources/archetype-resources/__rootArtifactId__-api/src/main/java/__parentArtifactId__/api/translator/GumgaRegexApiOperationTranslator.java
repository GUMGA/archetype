...
#set( $symbol_dollar = '$' )
#set( $symbol_escape = '\' )
package ${package}.${parentArtifactId}.api.translator;

import ${package}.${parentArtifactId}.configuration.security.OperationExpression;
import ${package}.${parentArtifactId}.configuration.security.SecurityIntegration;
