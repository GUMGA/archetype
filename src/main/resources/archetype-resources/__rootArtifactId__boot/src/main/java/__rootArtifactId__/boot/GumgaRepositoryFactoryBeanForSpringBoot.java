...
public class GumgaRepositoryFactoryBeanForSpringBoot<R extends JpaRepository<T, I>, T, I extends Serializable> extends JpaRepositoryFactoryBean<R, T, I> {
    ...
    protected RepositoryFactorySupport createRepositoryFactory(EntityManager entityManager) {
        ...
        System.out.println("------> Criando RepositoryFactory");
    ...
    private static class RepositoryFactoryForSpringBoot<T, I extends Serializable> extends JpaRepositoryFactory {
        ...
        protected <T, ID extends Serializable> SimpleJpaRepository<?, ?> getTargetRepository(RepositoryMetadata metadata, EntityManager entityManager) {
            System.out.println("------> Criando TargetRepository ENTITYMANAGER" + metadata.getDomainType());
        ...
        protected Object getTargetRepository(RepositoryInformation metadata) {
            System.out.println("------> Criando TargetRepository DOIDAO" + metadata.getRepositoryBaseClass());
            ...
            System.out.println("------> Criando TargetRepository 1 " + metadata1.getEntityName());
        ...
        protected Object getTargetRepository(RepositoryMetadata metadata) {
            System.out.println("------> Criando TargetRepository " + metadata.getDomainType());
        ...
        protected Class<?> getRepositoryBaseClass(RepositoryMetadata metadata) {
            System.out.println("------> RepositoryBaseClass " + metadata.getDomainType());
