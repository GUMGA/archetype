...
@SpringBootApplication(scanBasePackages = {"br.com.empresa.erp.boot.components", "br.com.empresa.erp.application.service", "io.gumga", "br.com.empresa.erp.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.empresa.erp.application.repository", "io.gumga"})
...
//GumgaQueryParserProvider.defaultMap = GumgaQueryParserProvider.getH2LikeMap();
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.empresa.erp.domain.model");
