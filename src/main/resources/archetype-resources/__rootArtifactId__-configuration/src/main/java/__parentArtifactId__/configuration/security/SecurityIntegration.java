...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(${package}.${parentArtifactId}.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*${parentArtifactId}-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-${parentArtifactId}", BASE + ".${parentArtifactId}.*", ".*")
    );
